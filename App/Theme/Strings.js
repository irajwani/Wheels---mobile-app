const EulaTop = `This End-User License Agreement ("EULA") is a legal agreement between you and Awitan. This EULA agreement governs your acquisition and use of our Awitan software ("Software") directly from Awitan or indirectly through a Awitan authorized reseller or distributor (a "Reseller"). \
Please read this EULA agreement carefully before completing the installation process and using the Awitan software. It provides a license to use the Awitan software and contains warranty information and liability disclaimers. \
By clicking "accept" or installing and/or using the Awitan software, you are confirming your acceptance of the Software and agreeing to become bound by the terms of this EULA agreement. \n
If you are entering into this EULA agreement on behalf of a company or other legal entity, you represent that you have the authority to bind such entity and its affiliates to these terms and conditions. If you do not have such authority or if you do not agree with the terms and conditions of this EULA agreement, do not install or use the Software, and you must not accept this EULA agreement.\
\n
This EULA agreement shall apply only to the Software supplied by Awitan herewith regardless of whether other software is referred to or described herein. The terms also apply to any Awitan updates, supplements, Internet-based services, and support services for the Software, unless other terms accompany those items on delivery. If so, those terms apply. \n
1. The App \n 
...
const EulaLink = 'https://awitan.com';
...
(iv) We do not check or moderate any User Content before it is added to the Service by users. We may later check, moderate, reject, refuse or delete any User Content if we think that it breaks any of the Rules of Acceptable Use, or we believe it is against the ethos of Awitan. \n
...
2. Use License \n
Permission is granted to temporarily download one copy of the materials on Awitan's application for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not: \n
• modify or copy the materials; \n
• use the materials for any commercial purpose or for any public display; \n
• attempt to reverse engineer any software contained on Awitan's application; \n
• remove any copyright or other proprietary notations from the materials; or \n
• transferring the materials to another person or "mirror" the materials on any other server. \n
This will let Awitan to terminate upon violations of any of these restrictions. Upon termination, your viewing right will also be terminated and you should destroy any downloaded materials in your possession whether it is printed or electronic format. \n
3. Disclaimer \n
All the materials on treet’s application are provided "as is". Awitan makes no warranties, may it be expressed or implied, therefore negates all other warranties. Furthermore, Awitan does not make any representations concerning the accuracy or reliability of the use of the materials on its application or otherwise relating to such materials or any sites linked to this application. \n
4. Limitations \n
Awitan or its suppliers will not be hold accountable for any damages that will arise with the use or inability to use the materials on treet’s application, even if Awitan or an authorized representative of this application has been notified, orally or written, of the possibility of such damage. Some jurisdiction does not allow limitations on implied warranties or limitations of liability for incidental damages, these limitations may not apply to you. \n
5. Revisions and Errata \n
The materials appearing on Awitan's application may include technical, typographical, or photographic errors. Awitan will not promise that any of the materials in this application are accurate, complete, or current. Awitan may change the materials contained on its application at any time without notice. Awitan does not make any commitment to update the materials. \n
6. Links \n
Awitan has not reviewed all of the sites linked to its application and is not responsible for the contents of any such linked site. The presence of any link does not imply endorsement by Awitan of the site. The use of any linked application is at the user’s own risk. \n
7. Application Terms of Use Modifications \n
Awitan may revise these Terms of Use for its application at any time without prior notice. By using this application, you are agreeing to be bound by the current version of these Terms and Conditions of Use. \n
8. Governing Law \n
Any claim related to Awitan's application shall be governed by the laws of Great Britain without regards to its conflict of law provisions.
`;

const PrivacyPolicy = `Effective date: May 31, 2020 \n
Awitan ("us", "we", or "our") operates the website and the Awitan mobile application (the "Service"). \n
This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy for Awitan is managed through Free Privacy Policy \n
...
\n
Use of Data\n
Awitan uses the collected data for various purposes: \n
...
Awitan will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information. \n
\n
Disclosure Of Data \n
Legal Requirements \n
Awitan may disclose your Personal Data in the good faith belief that such action is necessary to:\n
• To comply with a legal obligation \n
• To protect and defend the rights or property of Awitan \n
...
\n
Contact Us \n
If you have any questions about this Privacy Policy, please contact us by email: humzarana1@gmail.com`;

const ContactUs = 'Please send us an email at: humzarana1@gmail.com, and we shall get back to you as soon as possible.';
...
const searchPlaceholder = "Events and Awitaners", emptyFeed = "Such empty, much wow!", emptyGallery = "No pictures here yet!",
emptyField = "User has not input this information"

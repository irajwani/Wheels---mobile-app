...
const searchPlaceholder = "e.g. Louis Garneau", emptyFeed = "Such empty, much wow!", emptyGallery = "No pictures here yet!",
...
export default {
    ...
    EulaTop, EulaBottom, TsAndCs, PrivacyPolicy, ContactUs,
    Email, Phone, Address,

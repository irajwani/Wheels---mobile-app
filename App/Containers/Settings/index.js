...
class Settings extends Component {
    ...
    renderDocumentModal = () => (
        ...
        >
            <ModalContent>
                ...
                <ScrollView style={{height: Metrics.screenHeight/1.5}} contentContainerStyle={styles.documentScroll}>
    ...
    render() {
        return (
            <Container>
                <TabHeader text={"Settings"} button={() => <BackArrow onPress={() => NavigationService.goBack()}/>}/>
